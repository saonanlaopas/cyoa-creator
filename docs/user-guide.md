...
The passage-plan stage also contains bounded AI passage planning. It creates immutable, validated unit candidates for later proposal review. It does not alter the canonical passage plan; consolidation, proposal application, drafting, simulation, and publishing remain later checkpoints.
